  ...
  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" bgcolor="#CCCCCC">
    ...
    <tr bgcolor="#FFFFFF" valign="top" class="smallfont"> 
      <td  width = "17%" class="contentBgColor"><div align = "right">Staff Name 
          : </div></td>
      <td width = "83%" class="contentBgColor"><select name="staff" id="staff" style="font-family: Verdana, sans-serif; font-size: 11px;  8px;" onChange = 'document.form1.action="EIS.jsp?action=result_assessment";document.form1.submit();'>
          <option value="">...</option>
          <%
	if (conn!=null)
	{
...
%>
  ...
  <p>&nbsp;</p><table width="100%" border="0" align="center" bgcolor="#FFFFFF">
    <tr class="contentStrapColor"> 
      <td colspan="7"><strong>&nbsp;Staff Assessment Result</strong></td>
    </tr>
    <tr class="contentStrapColor"> 
      ...
      <td width="10%"> <div align="center"><strong>&nbsp;View</strong></div></td>
    </tr>
    <%
...
%>
      ...
      &nbsp;</td>-->
      <td align="center"> <A HREF="javascript:MM_openBrWindow('cms/EIS/view_assessment.jsp?action=result_assessment&staff=<%=staff%>&year_sah=<%= rset.getString(1) %>&assessment_grouping=<%=assessment_grouping%>', 'Purpose', 'resizable=yes,toolbar=no,scrollbars=yes,width=800,height=600')" class="style2" onMouseOver="window.status='Print';return true;"> 
        <strong>Print</strong></A> &nbsp;</td>
    </tr>
    <% 
	}
pstmt.close();
