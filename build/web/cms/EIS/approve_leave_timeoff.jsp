...
if (conn!=null)
	...
	try
		...
		if (rset.isBeforeFirst())
			{
%>
<form action="../leave/applyLeave.jsp" method="get" name="form1">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999" >
  <tr>
      <td class = "contentStrapColor"><b>Approve Leave</b></td>
  </tr>
                <tr>
                    <td>
          ...
          <tr> 
            ...
            <td width="7%" class="contentBgColor"><strong>Date From</strong></td>
            <td width="13%" class="contentBgColor"><strong>Date To</strong></td>
            <td width="13%" class="contentBgColor"><strong>Reason</strong></td>
            <td width="28%" class="contentBgColor"><strong>Details</strong></td>
...
%>
          <tr> 
            ...
            <td align="center" class="contentBgColorAlternate"><%=rset.getString(7)%></td>
            <td width="28%" class="contentBgColorAlternate">Details</td>
...
<%
			...
			{ %>They are no leave application waiting for your approval<% }
		pstmt.close ();
		}
