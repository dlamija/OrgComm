...
if ( conn!=null )
  ...
  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" bgcolor="#CCCCCC">
    <tr bgcolor="#666666" valign="top" class="smallfont"> 
      <td colspan="6" CLASS="contentStrapColor" align="center"><span class="style2 style1"><b>Assessment</b></span></td>
    </tr>
    <tr CELLSPACING="1" valign="top" bgcolor="#EEEEEE" class="smallbold"> 
      <td width="16%" class="contentBgColorAlternate"><div align="center"><b>Year</b></div></td>
      ...
      <td width="11%" class="contentBgColorAlternate"><div align="center"><b>Total 
          Day </b></div></td>
      <td width="30%" class="contentBgColorAlternate"><div align="center"><b>Reason</b></div></td>
      <td width="14%" class="contentBgColorAlternate"><div align="center"><b>Status</b></div></td>
    </tr>
   <%
		if(rset.isBeforeFirst())
		{
