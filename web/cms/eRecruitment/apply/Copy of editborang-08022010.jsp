...
{
if (document.applForm.post1_edit.value=='')
  {
     alert("Sila Pilih Jawatan (Please Select post)");
	 document.applForm.post1_edit.focus();
	 //return false;
  }
            ...
            <td><table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF" class='style2'>
                  ...
                  <td colspan="3" nowrap class=normaltext style='border-top:none'><br> 
                    <table width="100%" border="0" cellspacing="1" class='style2'>
                      <tr valign="top" bgcolor="#FFFFFF"> 
                        <td height="40" colspan="4"><img src="cms/eRecruitment/images/penting.gif" width="45" height="14"> 
                      ...
                      <tr bgcolor="#666666"> 
                        <td height="20" colspan="4"><strong><font color="#FFFFFF">&nbsp;Maklumat 
                          Permohonan Jawatan Terdahulu</font></strong></td>
                      </tr>
                      <tr bgcolor="#FFFFFF"> 
                        <td height="105" colspan="4"> 
                          <table width="100%" border="0" cellpadding="1" cellspacing="0" class="style2">
                            <tr> 
                            ...
                            <tr bgcolor="#EAF4FF"> 
                              ...
                              <th width="11%" height="20" class="style2" scope="row"> 
                                <div align="right">Jawatan : </div></th>
                              <td width="42%" height="20">&nbsp;<%=( ( desc_post2==null)?"-":desc_post2 )%></td>
                            </tr>
                            <tr bgcolor="#EAF4FF"> 
                              ...
                              <th height="20" class="style2" scope="row"> <div align="right"><span class="style5">Fakulti 
                                  : </span></div></th>
                              <td height="20">&nbsp;<%=( ( desc_dept2==null)?"-":desc_dept2 )%></td>
                            </tr>
                            <tr bgcolor="#EAF4FF"> 
                          ...
                          <p><a href="javascript:void(window.open('eRecruitment.jsp?action=edit_jawatan&refid=<%=refid%>','statistics', 'height=220,width=700,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Kemaskini Jawatan';return true;">Kemaskini 
                          Jawatan</a>Klik di sini untuk mengemaskini maklumat jawatan<br>
                          </p></td>
                      </tr>
                      <tr bgcolor="#666666"> 
                        <td height="20" colspan="4"><strong><font color="#FFFFFF">&nbsp;Kemaskini 
                          Jawatan </font></strong></td>
                      </tr>
                      <tr bgcolor="#CCCCCC"> 
                        <td bgcolor="#999999"> <div align="center"><strong>Pilihan 
                            Jawatan Pertama</strong></div></td>
                        <td width="83%" colspan="2"><b><font face="Geneva, Arial, Helvetica, san-serif"> 
                          ...
                          <select name="pilihan1" id="pilihan1" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;" onChange = 'document.applForm.action="eRecruitment.jsp?action=editborang&refid=<%=refid%>";document.applForm.submit();'>
                            ...
                            <option value="ACADEMIC" <% if (request.getParameter("pilihan1") != null &&  group_post1 !=null && request.getParameter("pilihan1").equals("ACADEMIC")) {%>selected<%} else if (request.getParameter("pilihan1") == null &&  group_post1 !=null && group_post1.equals("ACADEMIC")) {%>selected<%}%>>Jawatan 
                            Akademik</option>
                            <option value="NON ACADEMIC" <% if (request.getParameter("pilihan1") != null &&  group_post1 !=null && request.getParameter("pilihan1").equals("NON ACADEMIC")) {%>selected<%} else if (request.getParameter("pilihan1") == null && group_post1 !=null && group_post1.equals("NON ACADEMIC")) {%>selected<%}%>>Jawatan 
                            Bukan Akademik</option>
                          </select>
                          </font></b></td>
                      </tr>
                      <tr bgcolor="#EAF4FF"> 
                        <td colspan="4"> <table width="100%"  border="0" cellpadding="1" cellspacing="0" class='style2'>
                            <tr> 
                              <th width="17%" height="10" scope="row"> <div align="right">Jawatan 
                                  : </div></th>
                              <td width="83%" height="10"><input name="post1" type="hidden" id="post1" value="<%=job_post1%>"> 
								...
								%>
                                  <option value='<%=code%>' <% if (request.getParameter("post1_edit") != null && request.getParameter("post1_edit").equals(code) || service_code_post1!=null && service_code_post1.equals(code)) {%>selected<%}%>><%=jpa_code%> 
                                  - <%=desc%> 
                                  <%
                            ...
                            <tr> 
                              <th height="10" scope="row"> <div align="right"><span class="style5">Fakulti 
                                  : </span></div></th>
                              <td height="10"> <p> 
                                  <input name="closing_date_post1" type="hidden" id="closing_date_post1" value="<%=closing_date_post1%>">
                                  &nbsp;&nbsp; 
                                  ...
                                  <%=post1%> 
                                  <input name="closing_date1" type="hidden" id="closing_date1" value="<%=closing_edit_post1%>">clo<%=closing_edit_post1%>
                                </p></td>
                            </tr>
                            <tr> 
                                  ...
                                  <%
									String filterBidang1 = "";
										if (request.getParameter("dept") == null) 
											filterBidang1 = "AND RPD_REF_ID = '"+ post1 +"' ";
										...
										try
										{
											...
											//System.out.println(sql_threfid + "<br>");							
											Statement st_threfid=conn.createStatement();
											ResultSet rs_threfid=st_threfid.executeQuery(sql_threfid);
											while(rs_threfid.next())
											{
                      ...
                      <tr bgcolor="#CCCCCC"> 
                        <td bgcolor="#999999"> <div align="center"><strong>Pilihan 
                            Jawatan Kedua</strong></div></td>
                        <td colspan="2"><b><font face="Geneva, Arial, Helvetica, san-serif">&nbsp; 
                          <select name="pilihan2" id="pilihan2" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;" onChange = 'go3();'>
                            ...
                            <option value="ACADEMIC" <% if (request.getParameter("pilihan2") != null &&  group_post2 !=null && request.getParameter("pilihan2").equals("ACADEMIC")) {%>selected<%} else if (request.getParameter("pilihan2") == null &&  group_post2 !=null && group_post2.equals("ACADEMIC")) {%>selected<%}else if (request.getParameter("pilihan2") != null &&  group_post2 ==null && request.getParameter("pilihan2").equals("ACADEMIC")) {%>selected<%}%>>Jawatan 
                            Akademik</option>
                            <option value="NON ACADEMIC" <% if (request.getParameter("pilihan2") != null &&  group_post2 !=null && request.getParameter("pilihan2").equals("NON ACADEMIC")) {%>selected<%} else if (request.getParameter("pilihan2") == null && group_post2 !=null && group_post2.equals("NON ACADEMIC")) {%>selected<%}else if (request.getParameter("pilihan2") != null &&  group_post2 ==null && request.getParameter("pilihan2").equals("NON ACADEMIC")) {%>selected<%}%>>Jawatan 
                            Bukan Akademik</option>
                          </select>
                          </font></b></td>
                      </tr>
                        ...
                        <td colspan="4"><table width="100%"  border="0" cellpadding="1" cellspacing="0" class='style2'>
                            <tr> 
                              <th scope="row" width="17%"><div align="right">Jawatan 
                                  : </div></th>
                              <td width="83%">&nbsp;&nbsp; <input name="post2" type="hidden" id="post2" value="<%=job_post2%>"> 
                                <select name="post2_edit" size="1" id="post2_edit"  value="" onChange = 'go2();' style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;">
								  ...
								  String filterPilihan2 = "";
										if (request.getParameter("pilihan2") == null && group_post2 !=null) 
											...
											filterPilihan2 = "AND SS_GROUPING = null ";
										else 	if (request.getParameter("pilihan2") != null && group_post2 ==null)
											filterPilihan2 = "AND SS_GROUPING = '"+ pilihan2 +"' ";	
									try
									{
								...
								%>
                                  <option value='<%=code_post2%>' <% if (request.getParameter("post2_edit") != null && request.getParameter("post2_edit").equals(code_post2) || service_code_post2!=null && service_code_post2.equals(code_post2)) {%>selected<%}%>><%=jpa_code%> 
                                  - <%=desc%> 
                                  <%
                                ...
                                service 2 = <%=service_code_post2%>pilihan 2 =<%=pilihan2%> 
                              </td>
                            </tr>
                            <tr> 
                                  ...
                                  <select name="dept2" size="1" id="dept2" onChange='document.applForm.action="eRecruitment.jsp?action=editborang&refid=<%=refid%>";document.applForm.submit();' style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;">
									...
									String filterPilihan_post2 = "";
										...
										try
										{
											...
											//System.out.println (sql_threfid + "dept 2");
											Statement st_threfid=conn.createStatement();
											ResultSet rs_threfid=st_threfid.executeQuery(sql_threfid);
											while(rs_threfid.next())
											{
											...
											%>
                                    <option value='<%=refid2%>' <% if (request.getParameter("dept2") != null &&  request.getParameter("dept2").equals(refid2) || post2 != null && post2.equals(refid2)) {%>selected<%}%>><%=title2%> 
                                    <%
                            ...
                            <tr> 
                              <th scope="row"><div align="right"><span class="style5">Bidang 
                                  : </span></div></th>
                              <td>&nbsp; <select name="bidang_post2" size="1" id="bidang_post2" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;">
                                  <option value="">Pilih Bidang 
                                  <%
                ...
                <tr> 
                  ...
                  <td> <input type="text" name="t_mula"  value="<%=( ( t_mula==null)?"":t_mula )%>" size="12" maxlength="14" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px;"> 
                    ...
                    <font size="1">Sila masukkan apa-apa tarikh jika tiada pengalaman 
                    berkerja</font></td>
                </tr>
                <tr> 
