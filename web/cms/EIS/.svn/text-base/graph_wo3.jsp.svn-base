...
//String tahun=month.substring(36);
%><%//=tahun%><%
...
<head>
	...
	function printReport(tahun) 
	{
		if (ReportWin && !ReportWin.closed) ReportWin.close();			
			ReportWin = window.open('printReport.jsp?action=print_wo3&Month='+tahun, 'printReport', 'width=800,height=600,resizable=yes,scrollbars=1');
    ...
    <tr>
      ...
      <td height="65" valign="top" width="1173"><form action="EIS.jsp" method=post>
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="0">
            <tr> 
              <td width="45%"><div align="right"><span CLASS="contentTitleFont style30 style2"><font size="2">Month 
...
<table width="98%" height="73" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
   <!--- <tr>
	...
	strXML = "<graph caption='TITLE: STAFF WORKORDER - "+tahun+"' xAxisName='Staff ID' yAxisName='Count' showValues='1' decimalPrecision='0' formatNumberScale='0' showBorder='1'>";
