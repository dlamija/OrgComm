                  ...
                  <table width="100%" border="0" cellspacing="0" class='style2'>
                    <tr>
                      <td> &nbsp;&nbsp;&nbsp;&nbsp;<strong>Jawatan Akademik<br>
                        ...
                        <a href="javascript:void(window.open('cms/eRecruitment/attachment/JAWATAN_AKADEMIK_TAHUN_2010.pdf','statistics', 'height=600,width=800,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Jawatan Akademik';return true;">Maklumat 
                        Lanjut</a> <!--a href="javascript:void(window.open('cms/eRecruitment/jawatanakademik.jsp','statistics', 'height=600,width=800,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Jawatan Akademik';return true;">Maklumat 
                        Lanjut</a --><br>
