...
/**
 * @web.servlet name = "updateMtgType"
 * @web.servlet-mapping url-pattern = "/updateMtgType"
 */
public class UpdateMeetingType extends HttpServlet
{
  String mtgTypeDesc = null;
  String mtgTypeDept = null;
  String mtgTypeTitle = null;
  String errorMssg = null;
  String mtgTypeCode = null;
  String agendaTemplate = null;
    ...
    throws IOException, ServletException
  {
    ...
    this.mtgTypeCode = paramHttpServletRequest.getParameter("meetingTypeCode");
    this.agendaTemplate = paramHttpServletRequest.getParameter("agendaTemplate");
      ...
      try
      {
        ...
        if (localConnection != null)
        {
          ...
          if (localMeetingType != null)
          {
            ...
            localMeetingType.setAgendaTemplate(this.agendaTemplate.trim());
            localMeetingType.setMtgTypeParent(this.mtgTypeParent);
            localMeetingType.setMtgTypeLevel(this.mtgTypeLevel.trim());

            if (localMeetingType.updateMeetingType(this.mtgTypeCode.trim())) {
              i = 1;

              localHttpSession.setAttribute("mtgTypecode", this.mtgTypeCode);
            }
            else {
              i = 0;
    ...
    if (i != 0)
      paramHttpServletResponse.sendRedirect("eMeeting.jsp?action=updateMembers");
    else
