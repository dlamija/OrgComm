<%!//Page: FusionCharts.jsp
    //Author: Wan Azlee Bin Hj. Wan Abdullah
	//Pegawai Teknologi Maklumat & Komunikasi
    ...
    /**
     * Creates the Chart HTML+Javascript to create the Charts object with the given parameters.
    ...
    public String createChart(String chartSWF, String strURL, String strXML,
		...
		*/
		...
		/*Now, we render the chart using Charts Class. Each chart's instance (JavaScript) Id
