...
/**
 * @web.servlet name = "addmtg"
 * @web.servlet-mapping url-pattern = "/addmtg"
 */
public class NewMeeting extends HttpServlet
{
    ...
    throws IOException, ServletException
  {
      ...
      try
      {
        ...
        if (localConnection != null)
        {
          ...
          if (localMeeting != null) {
            ...
            localMeeting.setMtgType(this.mtgType.trim());
    ...
    if (i != 0) {
      paramHttpServletResponse.sendRedirect("eMeeting.jsp?action=main&group=" + mtgType);
    } else {
