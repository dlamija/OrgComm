...
//-->
 ...
 %>
  <TR>
      ...
      <select name="startDay" onChange="changeStartDayEventCalendarForm(document.calendarAppt);" style="display:none">
		<%  for (i=1;i<32;i++) {  %>
			  <option value="<%= ( i>0 && i<10 ? "0":"")+i %>"<% if (parameterInt > -1 && parameterInt == i ) { %> SELECTED<% } %>><%= ( i>0 && i<10 ? "0":"")+i %> </option>
		<%	}  %>		
        </select>
         <select name="startDay1" onChange="changeStartDayEventCalendarForm(document.calendarAppt);" disabled>
		<%  for (i=1;i<32;i++) {  %>
			  <option value="<%= ( i>0 && i<10 ? "0":"")+i %>"<% if (parameterInt > -1 && parameterInt == i ) { %> SELECTED<% } %>><%= ( i>0 && i<10 ? "0":"")+i %> </option>
		<%	}  %>		
        </select>
		...
		%>
        <SELECT NAME="startMonth" onChange="changeStartMonthEventCalendarForm(document.calendarAppt);" style="display:none">
         ...
         <SELECT NAME="startMonth1" onChange="changeStartMonthEventCalendarForm(document.calendarAppt);" disabled>
          <OPTION VALUE="01" <% if (!parameterStr.equals("") && parameterStr.equals("01") ) { %> SELECTED<% } %>><%= messages.getString("short.jan") %></option>
          <OPTION VALUE="02" <% if (!parameterStr.equals("") && parameterStr.equals("02") ) { %> SELECTED<% } %>><%= messages.getString("short.feb") %></OPTION>
          <OPTION VALUE="03" <% if (!parameterStr.equals("") && parameterStr.equals("03") ) { %> SELECTED<% } %>><%= messages.getString("short.mar") %></OPTION>
          <OPTION VALUE="04" <% if (!parameterStr.equals("") && parameterStr.equals("04") ) { %> SELECTED<% } %>><%= messages.getString("short.apr") %></OPTION>
		...
		%>
        <SELECT NAME="startYear" onChange="changeStartYearEventCalendarForm(document.calendarAppt);" style="display:none">
        <% for (i=Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.startYear"));
         ...
         <SELECT NAME="startYear1" onChange="changeStartYearEventCalendarForm(document.calendarAppt);" disabled>
        <% for (i=Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.startYear"));
             i <= Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.endYear"));
             i++) {
          %><OPTION VALUE="<%= i %>" <% if (parameterInt > -1 && parameterInt == i ) { %> SELECTED<% } %>><%= i %></OPTION><% } %>
      ...
      <div id="myContent1" style="position:absolute; width: 205px; height: 230px; left: 490px; top: 338px; display:none">
    ...
    <TR>
      ...
      <TD BGCOLOR="#EFEFEF" CLASS="contentBgColorAlternate" WIDTH="68%" VALIGN="TOP">                              
	    <% if (request.getParameter("endDay") != null) {
		 ...
		 %>
        <select name="endDay" onChange="changeEndDayEventCalendarForm(document.calendarAppt);" style="display:none">
		<%  for (i=1;i<32;i++) {  %>
			  <option value="<%= ( i>0 && i<10 ? "0":"")+i %>" <% if (parameterInt > -1 && parameterInt == i ) { %> SELECTED<% } %>><%= ( i>0 && i<10 ? "0":"")+i %> </option>
		<%	} %>		
        </select>
            <select name="endDay1" onChange="changeEndDayEventCalendarForm(document.calendarAppt);" disabled>
		<%  for (i=1;i<32;i++) {  %>
			  <option value="<%= ( i>0 && i<10 ? "0":"")+i %>" <% if (parameterInt > -1 && parameterInt == i ) { %> SELECTED<% } %>><%= ( i>0 && i<10 ? "0":"")+i %> </option>
		<%	} %>		
        </select>
        ...
        <SELECT NAME="endMonth" onChange="changeEndMonthEventCalendarForm(document.calendarAppt);" style="display:none">
          <OPTION VALUE="01" <% if (!parameterStr.equals("") && parameterStr.equals("01") ) { %> SELECTED<% } %>><%= messages.getString("short.jan") %></option>
          <OPTION VALUE="02" <% if (!parameterStr.equals("") && parameterStr.equals("02") ) { %> SELECTED<% } %>><%= messages.getString("short.feb") %></OPTION>
          <OPTION VALUE="03" <% if (!parameterStr.equals("") && parameterStr.equals("03") ) { %> SELECTED<% } %>><%= messages.getString("short.mar") %></OPTION>
          <OPTION VALUE="04" <% if (!parameterStr.equals("") && parameterStr.equals("04") ) { %> SELECTED<% } %>><%= messages.getString("short.apr") %></OPTION>
        ...
        <SELECT NAME="endMonth1" onChange="changeEndMonthEventCalendarForm(document.calendarAppt);" disabled>
          <OPTION VALUE="01" <% if (!parameterStr.equals("") && parameterStr.equals("01") ) { %> SELECTED<% } %>><%= messages.getString("short.jan") %></option>
          <OPTION VALUE="02" <% if (!parameterStr.equals("") && parameterStr.equals("02") ) { %> SELECTED<% } %>><%= messages.getString("short.feb") %></OPTION>
          <OPTION VALUE="03" <% if (!parameterStr.equals("") && parameterStr.equals("03") ) { %> SELECTED<% } %>><%= messages.getString("short.mar") %></OPTION>
          <OPTION VALUE="04" <% if (!parameterStr.equals("") && parameterStr.equals("04") ) { %> SELECTED<% } %>><%= messages.getString("short.apr") %></OPTION>
        ...
        <SELECT NAME="endYear" onChange="changeEndYearEventCalendarForm(document.calendarAppt);" style="display:none">
        <%
        for (i=Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.startYear"));
             i <= Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.endYear"));
             i++)
        ...
        %>
           ...
           <SELECT NAME="endYear1" onChange="changeEndYearEventCalendarForm(document.calendarAppt);" disabled>
        <%
        for (i=Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.startYear"));
             i <= Integer.parseInt((String)TvoContextManager.getAttribute(request, "System.endYear"));
             i++)
       ...
       <!--a id="displayText" href="javascript:toggle();">show</a -->
      <div id="myContent2" style="position:absolute; width: 205px; height: 230px; left: 490px; top: 355px; display:none">
