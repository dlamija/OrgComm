<%@page import="utilities.RecipientUtil, paulUtil.ConvUtil" %>
<%
  int i;
              ...
              <TR VALIGN="TOP">
                <TD>
                  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3">
                    <TR VALIGN="MIDDLE">
										<% if (showIcon) { %>
											  <TD HEIGHT="16" <%= action.equals("viewDay") ? "BACKGROUND=\"images/system/dailystrap.gif\"" : "" %><%= action.equals("viewWeek") ? "BACKGROUND=\"images/system/weeklystrap.gif\"" : "" %><%= action.equals("viewMonth") ? "BACKGROUND=\"images/system/monthlystrap.gif\"" : "" %> COLSPAN="2"><A HREF="calendar.jsp?action=viewDay" onMouseOver="window.status='View Day';return true;"><IMG SRC="images/system/blank.gif" WIDTH="77" HEIGHT="16" BORDER="0"></A><A HREF="calendar.jsp?action=viewWeek" onMouseOver="window.status='View Week';return true;"><IMG SRC="images/system/blank.gif" WIDTH="86" HEIGHT="16" BORDER="0"></A><A HREF="calendar.jsp?action=viewMonth" onMouseOver="window.status='View Month';return true;"><IMG SRC="images/system/blank.gif" WIDTH="89" HEIGHT="16" BORDER="0"></A></TD>
										<% } else { %>
                      <TD HEIGHT="22" COLSPAN="2" BACKGROUND="images/system/strap.gif"><IMG SRC="images/system/blank.gif" WIDTH="20" HEIGHT="5"><FONT COLOR="#FFCC66" SIZE="2" CLASS="<%= contentTitleFont %>"><%= messages.getString("calendar") %></FONT></TD>
										<% } %>
                    </TR>
                    ...
                    <TR VALIGN="MIDDLE" >
                      <TD BGCOLOR="#003366" CLASS="contentStrapColor" COLSPAN="2" ALIGN="RIGHT">
