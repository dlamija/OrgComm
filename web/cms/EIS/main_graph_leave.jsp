...
<p align="center">Kekerapan Cuti Berdasarkan Bulan</p>
<table width="98%" height="73" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <input type=hidden name=action value=graph_leave>
...
if (conn!=null)
	{
	String sql = " SELECT DISTINCT TO_CHAR(SLD_APPLY_DATE, 'MONTH YYYY') SLD_APPLY_DATE, "+ 
				" TO_CHAR(SLD_APPLY_DATE,'MONTH YYYY') "+
...
%>
                  <option value="EIS.jsp?action=main_graph_leave&month=<%=rset1.getString(1)%>"><%=rset1.getString(2)%></option>
                  <%
			}
%>
                </select>
