          ...
          <TD width="343" height="270" valign="top" style="padding-left:0; "><br>
            <table width="99%" border="0" align="right" cellspacing="0">
              <tr> 
                ...
                <a href="http://pendaftar.ump.edu.my/index.php/bpsm/lain-lain/polisi/119.html" target="_blank"><font color="#0000FF">here.</font></a></STRONG></span></td>
              </tr>
              <tr>
                    ...
                    <tr>
                      <td> &nbsp;&nbsp;&nbsp;&nbsp;<strong>Jawatan Akademik<br>
                       ...
                       <%-- Tiada Sebarang Perjawatan--%>
                        ...
                        Lanjut</a -->
                        <a href="javascript:void(window.open('cms/eRecruitment/jawatanakademik.jsp','statistics', 'height=600,width=800,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Jawatan Akademik';return true;">Maklumat 
                        Lanjut</a><br>
                  ...
                  <table width="100%" border="0" cellspacing="0" class='style2'>
                    <tr>
                      <td>&nbsp;&nbsp;&nbsp;&nbsp;<strong>Jawatan Bukan Akademik</strong> 
                        ...
                        <a href="javascript:void(window.open('cms/eRecruitment/jawatannonakademik.jsp','statistics', 'height=600,width=800,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Jawatan Non Akademik';return true;">Maklumat 
                        Lanjut</a> &nbsp;&nbsp;<!--IMG SRC="cms/eRecruitment/images/icon_new2.jpg" WIDTH=30 HEIGHT=15 ALT=""--><br>
