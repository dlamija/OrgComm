...
<TABLE WIDTH=775 height="568" BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
  ...
  <TR> 
    <TD height="355" valign="top" bgcolor="#F3F3F3" class='style2'><br>
      ...
      <br>
      <br>
      <table width="60%" border="0" align="center" cellspacing="1" class='style2'>
        <tr> 
          <td width="100%" height="30"> <div align="center"><strong>Pertanyaan 
              : </strong></div></td>
        </tr>
        <tr bordercolor="#C1E0FF" bgcolor="#C1E0FF"> 
          <td height="50" bgcolor="#C1E0FF"> <table width="100%" height="150" border="0" align="center" cellspacing="0" class='style2'>
              <tr bordercolor="#C1E0FF" bgcolor="#EAF4FF"> 
                <td width="70%" colspan="2"><div align="center"> 
                    <p><strong>Unit Perjawatan &amp; Cuti Belajar,</strong><br>
