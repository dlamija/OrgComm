...
/**
 * @web.servlet name = "addsenatenotes"
 * @web.servlet-mapping url-pattern = "/addsenatenotes"
 */
public class NewSenateNotes extends HttpServlet
{
  String noteSeq = null;
    ...
    throws IOException, ServletException
  {
    ...
    if (i != 0)
      CommonFunction.printAlert(paramHttpServletRequest, paramHttpServletResponse, "Notes Created Successfully", "senateMeeting.jsp?action=Notes&meetingCode=" + this.mtgCode + "#" + this.noteSeq + "_updateForm");
    else
      CommonFunction.printAlert(paramHttpServletRequest, paramHttpServletResponse, this.errorMssg, "senateMeeting.jsp?action=Notes&meetingCode=" + this.mtgCode + "#" + this.noteSeq + "_updateForm");
  }
}