...
/**
 * @web.servlet name = "updateMinutes"
 * @web.servlet-mapping url-pattern = "/updateMinutes"
 */
public class UpdateMinutes extends HttpServlet
{
      ...
      try
      {
        ...
        if (localConnection != null)
        {
          ...
          if (localMeetingMinutes != null)
          {
            ...
            if (localMeetingMinutes.updateMinutes()) {
              i = 1;
            }
            else {
              i = 0;
              localHttpSession.setAttribute("errmsg", localMeetingMinutes.getErrorMessage());
            }
          } else {
            i = 0;
