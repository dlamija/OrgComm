                  ...
                  <table width="100%" border="0" cellspacing="0" class='style2'>
                    <tr>
                      <td>&nbsp;&nbsp;&nbsp;&nbsp;<strong>Jawatan Bukan Akademik</strong> 
                        ...
                        <a href="javascript:void(window.open('cms/eRecruitment/attachment/Iklan jawatan kosong UMP Siri 10-2012 e-Recruit  29 OGOS 2012-B_doc.pdf','statistics', 'height=700,width=900,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Jawatan Non Akademik';return true;">Maklumat 
                        Lanjut</a> &nbsp;&nbsp;<IMG SRC="cms/eRecruitment/images/baru.gif" width="25" height="10" ALT=""><br>
