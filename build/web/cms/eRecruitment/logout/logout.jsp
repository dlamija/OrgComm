...
<TABLE WIDTH=775 height="572" BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
  <TR> 
  ...
  <TR> 
    <TD height="355" valign="top" bgcolor="#F3F3F3" class='style2'><div align="center">
        <p><br>
          <br>
          <br>
          <br>
          ...
          <b>Session ID: </b><%= session.getId() %> <strong><br>
          <br>
          </strong></p>
        <p>&nbsp;</p>
        <p><strong> Anda telah keluar daripada sistem e-Recruitment.<br>
          Sila login untuk menggunakan sistem ini.<br>
          <br>
