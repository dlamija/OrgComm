...
<TABLE id=Table_01 height=82 cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
	<TBODY>
    	<TR> 
      		<TD width="1%" height=39><IMG height=39 alt="" src="../announcement/entry/images/clas_01.gif" width=16></TD>
      		<TD width="97%" background="../announcement/entry/images/clas_02.gif"> 
        		<DIV align=center>
      		...
      		<TD width="2%"> <DIV align=left><IMG height=39 alt="" src="../announcement/entry/images/clas_04.gif" width=17></DIV></TD>
    	</TR>
    	<TR> 
     		<TD background="../announcement/entry/images/clas_05.gif" height=27>
			 	<IMG height=24 alt="" src="../announcement/entry/images/clas_05.gif" width=16></TD>
      		<TD vAlign=top bgColor=#ffffff>
				<DIV align=center> <font color="#333333"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"></font></strong></font>
      ...
      <TD 
                            background="../announcement/entry/images/clas_07.gif"> 
        <DIV align=left><IMG height=27 alt="" 
                              src="../announcement/entry/images/clas_07.gif" 
                              width=17></DIV></TD>
    </TR>
    <TR> 
      <TD><IMG height=16 alt="" 
                              src="../announcement/entry/images/clas_08.gif" 
                              width=16></TD>
      <TD 
                            background="../announcement/entry/images/clas_09.gif"><IMG 
                              height=16 alt="" 
                              src="../announcement/entry/images/clas_09.gif" 
                              width=199></TD>
      <TD> <DIV align=left><IMG height=16 alt="" 
                              src="../announcement/entry/images/clas_10.gif" 
                              width=17></DIV></TD>
    </TR>
  </TBODY>
</TABLE>
