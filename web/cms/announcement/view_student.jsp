...
if (conn!=null)
	{
		...
		sql_daily	= "SELECT AM.AM_REF,AC.AC_CAT_DESC,AM.AM_TITLE,AM.AM_MESSAGE,TO_CHAR(AM.AM_DATE,'DD-MON-YY'),AM.AM_URL,AM.AM_STATUS "+
                       "FROM CMSADMIN.ANNOUNCEMENT_MAIN AM,CMSADMIN.ANNOUNCEMENT_CATEGORY AC,CMSUSERS_VIEW "+
					   "WHERE AM.AM_POSTED_BY = CMSID AND AC.AC_CAT_ID = AM.AM_CATEGORY "+
					   "AND USERTYPE='STUDENT' "+
					    "AND SYSDATE <= AM.AM_APPROVE_DATE + AM.AM_TOTAL_DAY "+
					   "ORDER BY AM.AM_DATE DESC ";
