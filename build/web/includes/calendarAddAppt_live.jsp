 ...
 %>
    <TR>
      ...
      <TD BGCOLOR="#EFEFEF" CLASS="contentBgColorAlternate" WIDTH="68%" VALIGN="TOP">
        ...
        <select name="startDay" onChange="changeStartDayEventCalendarForm(document.calendarAppt);">
		<%  for (i=1;i<32;i++) {  %>
		...
		%>
        <SELECT NAME="startMonth" onChange="changeStartMonthEventCalendarForm(document.calendarAppt);">
		...
		%>
        <SELECT NAME="startYear" onChange="changeStartYearEventCalendarForm(document.calendarAppt);">
