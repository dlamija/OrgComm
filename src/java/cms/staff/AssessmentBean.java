...
public class AssessmentBean
{
    ...
    public boolean SaveRemarkPpp(String s, String s1, String s2, String s3, int i)
    {
        boolean flag = true;
        String s4 = "UPDATE STAFF_ASSESSMENT_HEAD SET SAH_EVALUATOR1_REMARK1 = ? ,SAH_EVALUATOR1_REMARK2 = ? ,SAH_EVALUATOR1_mth = ? WHERE SAH_STAFF_ID = ? AND SAH_YEAR = ? ";
        try
        {
    ...
    public boolean SaveRemarkPpk(String s, String s1, String s2, int i)
    {
        boolean flag = true;
        String s3 = "UPDATE STAFF_ASSESSMENT_HEAD SET SAH_EVALUATOR2_REMARK = ? ,SAH_EVALUATOR2_mth = ? WHERE SAH_STAFF_ID = ? AND SAH_YEAR = ? ";
        try
        {
