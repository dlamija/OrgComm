...
%>
<li><A HREF="EIS.jsp" onMouseOver="window.status='Executive Approval System';return true;"><img src="images/execMenu.gif"></A></li>
  <%}%>
 <li><a class="MenuBarItemSubmenu" href="#"><img src="images/generalMenu.gif"></a>
    <ul>
...
<div align="left">
  ...
  <!--li>
    <div align="left"><a href="legal.jsp" onMouseOver="window.status='Legal Management';return true;"><FONT COLOR="#000000">Legal 
      Management</FONT></A></div>
        ...
        <li>
        <a class="MenuBarItemSubmenu" href="#">Network & Telecomunication System</a>
        <ul>
          ...
          <li><A HREF="webBillApps.jsp"  onMouseOver="window.status='Call Billing System';return true;"><FONT COLOR="#000000" >Call Billing System</FONT></A></li>
        </ul>
      </li>
  ...
  <!-- flexmenu2 - Staff Management -->
    <!-- Menu Personal -->
 <li><a class="MenuBarItemSubmenu" href="#"><img src="images/staffMenu.gif"></a>
    <ul>
...
<li><a href="medical.jsp" onMouseOver="window.status='Non Panel Clinic Claim';return true;"><font COLOR="#000000">Non Panel Clinic Claim</font></a></li>-->
 ...
 <li><a class="MenuBarItemSubmenu" href="#"><img src="images/stdMenu.gif"></a>
    <ul>
		<!-- HEP inventory-->
 ...
 <li><a class="MenuBarItemSubmenu" href="#"><img src="images/financeMenu.gif"></a>
    <ul>
       <li><a class="MenuBarItemSubmenu" href="#">Financial Info</a> 
		...
		<!-- end flexmenu4 -->
<!-- research menu -->
<li><A HREF="rndmgmt.jsp" onMouseOver="window.status='Research Management System';return true;"><img src="images/searchMenu.gif"></A></li>
<!-- end research menu -->
...
%>
 ...
 <li><a class="MenuBarItemSubmenu" href="#"><img src="images/securityMenu.png"></a>
    <ul>        <!-- -CCTV -->
     ...
     <li><a class="MenuBarItemSubmenu" href="#"><img src="images/trainingMenu.png"></a>
    <ul>
      ...
      <a href="#">CPD@UMP</a> 
          ...
          <li> 
        <a href="training.jsp">Staff Training Summary</a> 
               </li>
      </ul>
      </ul>
      </li>
