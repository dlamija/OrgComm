...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" bgcolor="#CCCCCC">
  <tr valign="top" bgcolor="#EEEEEE" class="smallbold"> 
    <td colspan="6" class="contentStrapColor"><strong>STAFF WORKORDER</strong></td>
  </tr>
  <tr valign="top" bgcolor="#EEEEEE" class="smallbold"> 
    ...
    <td width="37%" class="contentStrapColor"><div align="center"><b>Department 
        </b></div></td>
    <td width="10%" align=center class="contentStrapColor"><div align="center"><b>Link</b></div></td>
  </tr>
  <%
	  if (rset.isBeforeFirst ()) 
	  {
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="smallfont"> 
    ...
    <td class = "contentBgColor"><div align="center"><a href="EIS.jsp?action=approve_wo2"> 
        Link</a></div></td>
  </tr>
  <% 
		} 
