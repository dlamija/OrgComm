...
if ( conn!=null )
	...
	{	
		...
		String sql1	=	" SELECT sm_staff_name,UPPER(ss_service_desc), "+
...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" bgcolor="#CCCCCC">
  <tr valign="top" bgcolor="#EEEEEE" class="smallbold"> 
    <td colspan="6" class="contentStrapColor"><strong>STAFF LEAVE</strong></td>
  </tr>
  <tr valign="top" bgcolor="#EEEEEE" class="smallbold"> 
    <td width="5%" class="contentStrapColor"><div align="center"><strong>Bil</strong></div></td>
    ...
    <td width="21%" class="contentStrapColor"><div align="center"><b>Department 
        </b></div></td>
    <td width="29%" align=center class="contentStrapColor"><div align="center"></div></td>
  </tr>
  <%
	  if (rset.isBeforeFirst ()) 
	  {
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="smallfont"> 
    ...
    <td class = "contentBgColor"><div align="center"><a href="EIS.jsp?action=approve_leave"> 
        </a>
        <form><%
if (conn!=null)
	{
	String sql ="SELECT SAH_REF_ID,SAH_STAFF_ID,SM_STAFF_NAME,TO_CHAR(SAH_DATE,'MM/YYYY') SAH_DATE,TO_CHAR(SAH_DATE,'MONTH YYYY'), " +
...
%>
            <option value="timeoffApplication.jsp?action=query_surbodinate&month=<%=rset1.getString(4)%>"><%=rset1.getString(5)%></option>
            <%
			}
%>
          </select>
...
%>
          <input type="hidden" name="staff" value="<%=rset.getString(8)%>" />
