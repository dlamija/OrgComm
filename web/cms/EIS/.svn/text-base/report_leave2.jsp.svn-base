...
if ( conn!=null )
	...
	String sql=" SELECT SM_STAFF_NAME,SLD_APPLY_DATE,SLD_DATE_FROM,SLD_DATE_TO, "+
			" SLD_LEAVE_REASON,SLD_STATUS,SLD_TOTAL_DAY "+
			" FROM STAFF_LEAVE_DETL,STAFF_MAIN,STAFF_ATTENDANCE_HEAD "+
  ...
  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" bgcolor="#CCCCCC">
    <tr bgcolor="#666666" valign="top" class="smallfont"> 
      <td colspan="6" CLASS="contentStrapColor" align="center"><span class="style2 style1"><b>Staff 
    ...
    <tr CELLSPACING="1" valign="top" bgcolor="#EEEEEE" class="smallbold"> 
      <td width="14%" class="contentBgColorAlternate"><div align="center"><b>Date 
          Apply</b></div></td>
      <td width="9%" class="contentBgColorAlternate"><div align="center"><b>Date 
          From</b></div></td>
      <td width="8%" class="contentBgColorAlternate"><div align="center"><b>Date 
          To </b></div></td>
      <td width="11%" class="contentBgColorAlternate"><div align="center"><b>Total 
          Day </b></div></td>
      <td width="32%" class="contentBgColorAlternate"><div align="center"><b>Reason</b></div></td>
      <td width="12%" class="contentBgColorAlternate"><div align="center"><b>Status</b></div></td>
    </tr>
    <%
		if(rset.isBeforeFirst())
	{
...
//	hr = hr + (min / 60);	min = min % 60;
    ...
    <%}%>
    <tr valign="top" bgcolor="#FFFFFF" class="smallfont"> 
      <td colspan="6" CLASS="contentBgColorAlternate" align="center"><b> </b> 
      </td>
    </tr>
  </table>
  <br>
