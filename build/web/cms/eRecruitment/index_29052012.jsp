                  ...
                  <table width="100%" border="0" cellspacing="0" class='style2'>
                    <tr>
                      <td>&nbsp;&nbsp;&nbsp;&nbsp;<strong>Jawatan Bukan Akademik</strong> 
                        ...
                        <a href="javascript:void(window.open('cms/eRecruitment/attachment/Iklan jawatan kosong UMP Siri 3-2012 e-Recruit  16 MEI 2012_doc.pdf','statistics', 'height=700,width=900,menubar=no,toolbar=no,scrollbars=yes'))" onMouseOver="window.status='Jawatan Non Akademik';return true;">Maklumat 
