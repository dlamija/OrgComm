...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
  <tr>
	...
	<form name="composeMemo" action="Memo?action=compose" method="post" ENCTYPE="multipart/form-data">
		<table>
			<tr>
...
%>	   
		...
		<TR VALIGN="TOP" BGCOLOR="#DBDBDB">
		  <TD CLASS="contentBgColor" bgcolor='#D9F2FF' style="font-family: Verdana, sans-serif; font-size: 11px;  8px; " COLSPAN="4" ALIGN="center">
			...
			<textarea class="input_text" COLS="40" ROWS="15" id="memoMessage2" name="memoMessage2" style="width:600; height:250">
				<%=memoMessage2%>
			</textarea>
			 <!-- 
			...
			<script type="text/javascript">
				CKEDITOR.replace( 'memoMessage2' , { toolbar : 'umpLite' });
			</script>
		  </td>
		</tr>
